...
public class LoanDetailPage {
    ...
    public String widgetHeader="//div[@id='LOAN_DETAILS']//div[2]//div[@class='card__card-header--card-body--table--list-heading left-spacing']//div[";
    public String value="]//span";
    public String columnValue="//div[@id='LOAN_DETAILS']//div[2]//div[@class='card__card-header--card-body--table--data-list innertable-area ng-star-inserted']//div[";
    public String loanRecoveryWidgetHeader="//div[@id='LOAN_HISTORY']//div[2]//div[@class='card__card-header--card-body--table--list-heading left-spacing']//div[";
