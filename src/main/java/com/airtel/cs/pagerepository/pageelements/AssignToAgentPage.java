...
public class AssignToAgentPage {
    public By pageTitle = By.xpath("//*[@id='assignTicket']/app-assign-to-agents//h4");
    ...
    public By queueName = By.xpath("//*[@id='assignTicket']//*[text()='Queue']/../p");
    public By agentName = By.xpath("//*[@id='assignTicket']//*[contains(@class,'agent-list')][1]//p/span");
    public By agentAuuid = By.xpath("//*[@id='assignTicket']//*[contains(@class,'agent-list')][1]//p/span[2]");
    public By assignBtn = By.xpath("//*[@id='assignTicket']//*[contains(@class,'agent-list')][1]//img");
    ...
    public By allAvailableSlot = By.xpath("//*[@id='assignTicket']//*[text()='Available Slot']/following-sibling::p/span");
