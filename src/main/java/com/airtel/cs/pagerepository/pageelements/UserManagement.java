...
public class UserManagement {
    ...
    public String list="//mat-select[starts-with(@class,'mat-select ng-tns') and @aria-multiselectable='true']";
    public String backButton="//div[@class='cdk-overlay-backdrop cdk-overlay-transparent-backdrop cdk-overlay-backdrop-showing']";
    public String auuid="//div[@title='";
