...
public class WidgetInteractionPage {
    ...
    public String issueLabelList="//div[@class=bottom-drawer__card-body--intraction-list ng-star-inserted][";
    public String issueLabel="]//label";
    public String labelContains="//label[contains(text(),'";
}
