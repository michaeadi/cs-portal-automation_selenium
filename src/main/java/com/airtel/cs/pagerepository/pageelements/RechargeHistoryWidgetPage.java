...
public class RechargeHistoryWidgetPage {
    ...
    public By ticketIcon = By.xpath("//div[data-csautomation-key='RECHARGE_HISTORY']//span/img[@class='interaction-ticket']");
    ...
    public By refillIconDisable = By.xpath("//div[data-csautomation-key='RECHARGE_HISTORY']//span/img[@class='header-action-icon disabled ng-star-inserted']");
    public By refillIconClickable = By.xpath("//div[data-csautomation-key='RECHARGE_HISTORY']//parent::div//span[2]/span/img[@class='header-action-icon ng-star-inserted']");
    ...
    public By widgetLoader = By.xpath("//div[data-csautomation-key='USAGE_HISTORY']//div[contains(@class,'animated-background')]");
    public By footerRHWAuuid = By.xpath("//div[data-csautomation-key='RECHARGE_HISTORY']//div[contains(@class,'auuid-container')]");
    public By middleRHWAuuid = By.xpath("//div[data-csautomation-key='RECHARGE_HISTORY']");
    public String dataRow = "//div[data-csautomation-key='RECHARGE_HISTORY']//div[contains(@class,'table-data-wrapper')]/div[";
    public String valueColumns = "]//div[contains(@class,'data-list')]/div[";
    public String headerRow="//div[data-csautomation-key='RECHARGE_HISTORY']//div[@class='card__card-header--card-body--table--list-heading ng-star-inserted']/div[";
