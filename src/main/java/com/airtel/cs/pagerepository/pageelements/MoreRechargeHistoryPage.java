...
public class MoreRechargeHistoryPage {
    ...
    public String headerName="//div[@data-csautomation-key='INTERNET_BUNDLES_HISTORY']//div[contains(@class,'card-body--table--list-heading')]//div[";
    ...
    public String widgetIdentifier="//div[@data-csautomation-key='INTERNET_BUNDLES_HISTORY']";
}
