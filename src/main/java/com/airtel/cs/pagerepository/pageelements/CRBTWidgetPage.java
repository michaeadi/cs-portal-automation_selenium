...
public class CRBTWidgetPage {
    ...
    public By myTuneTab = By.xpath("//div[@id='RING_BACK_TUNE']//*[text()='My Tunes']");
    public By top20TuneTab = By.xpath("//div[@id='RING_BACK_TUNE']//*[text()='Top 20 Tunes']");
    public By searchTuneTab = By.xpath("//div[@id='RING_BACK_TUNE']//*[text()='Search Tunes']");
    public By noResultImg = By.xpath("//div[@id='RING_BACK_TUNE']//app-data-loading-error//img");
    public By noResultMessage = By.xpath("//div[@id='RING_BACK_TUNE']//div[contains(@class,'no-result-found')]/span");
    public By widgetError = By.xpath("//div[@id='RING_BACK_TUNE']//app-data-loading-error//img");
    ...
    public By widgetLoader = By.xpath("//div[@id='RING_BACK_TUNE']//div[contains(@class,'animated-background')]");
    public By footerCRBTAuuid = By.xpath("//div[@id='RING_BACK_TUNE']//div[contains(@class,'auuid-container')]");
    public By middleCRBTAuuid = By.xpath("//div[@id='RING_BACK_TUNE']");
    public String crbtTableHeader = "//div[@id='RING_BACK_TUNE']//div[contains(@class,'table--list-heading')]/div[";
