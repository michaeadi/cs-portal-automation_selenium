...
public class UsageWidgetPage {
    ...
    public By rows = By.xpath("//div[@id='USAGE_HISTORY']//div[contains(@class,'table-data-wrapper')]//div[contains(@class,'data-list')]");
    ...
    public By footerUHWAuuid = By.xpath("//*[@id='USAGE_HISTORY']//*[@class='auuid-container']");
    public By middleUHWAuuid = By.xpath("//*[@id='USAGE_HISTORY']");
    public String dataRow = "//div[@id='USAGE_HISTORY']//div[contains(@class,'table-data-wrapper')]/div[";
