...
public class DetailedUsageHistoryPageElements {
    ...
    public By todayDateFilter = By.xpath("//div[@id='DETAILED_USAGE_HISTORY']//form/span[3]//mat-radio-button[1]//span[contains(text(),'Today')]");
    public By last2DayDateFilter = By.xpath("//div[@id='DETAILED_USAGE_HISTORY']//form/span[3]//mat-radio-button[2]//span[contains(text(),'two days')]");
    public By last7DayDateFilter = By.xpath("//div[@id='DETAILED_USAGE_HISTORY']//form/span[3]//mat-radio-button[3]//span[contains(text(),'seven days')]");
