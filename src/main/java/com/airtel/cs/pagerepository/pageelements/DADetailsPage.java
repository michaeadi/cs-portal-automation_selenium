...
public class DADetailsPage {
     ...
     * */
    public By rows = By.xpath("//div[@data-csautomation-key='DA_ACCOUNTS']//div[@class='table-data-wrapper ng-star-inserted']/div[@class='ng-star-inserted']");
    ...
    public By ticketIcon = By.xpath("//div[@data-csautomation-key='DA_ACCOUNTS']//span/img[@class='interaction-ticket']");
    public By getTitle = By.xpath("//div[@data-csautomation-key='DA_ACCOUNTS']//span[@class='card__card-header--label']");
    ...
    public String valueRow = "//div[@data-csautomation-key='DA_ACCOUNTS']//div[@class='table-data-wrapper ng-star-inserted']/div[@class='ng-star-inserted'][";
    /**
     * Page Elements of Accumulator Widget
     * */
    public String accumulatorHeader="//div[@data-csautomation-key='ACCUMULATORS']//div[@class='card__card-header--card-body--table--list-heading ng-star-inserted']//div[";
    public String accumulatorColumnHeader="//div[@data-csautomation-key='ACCUMULATORS']//div[@class='table-data-wrapper ng-star-inserted']/div[@class='ng-star-inserted'  or @class='slide-toggle red ng-star-inserted'][";
    public String accumulatorColumnValue="]//div[@class='data-container ng-star-inserted'][";
    /**
     * Page Elements of UC & UT Offer Widget
     * */
    public String offerHeader="//div[@data-csautomation-key='DISPLAY_OFFERS']//div[@class='card__card-header--card-body--table--list-heading ng-star-inserted']//div[";
    public String offerColumnHeader="//div[@data-csautomation-key='DISPLAY_OFFERS']//div[@class='table-data-wrapper ng-star-inserted']/div[@class='ng-star-inserted'  or @class='slide-toggle red ng-star-inserted'][";
    ...
    public String displayOfferTitle="//div[@data-csautomation-key='DISPLAY_OFFERS']";
    ...
    public By offerPagination=By.xpath("//div[@data-csautomation-key='DISPLAY_OFFERS']//div[@class='pagination ng-star-inserted']");
    /**
     * Page Elements of Friends & Family Detail Widget
     * */
    public String fnfTitle="//div[@data-csautomation-key='FRIENDS_AND_FAMILY']";
    public String fnfHeader="//div[@data-csautomation-key='FRIENDS_AND_FAMILY']//div[@class='card__card-header--card-body--table--list-heading ng-star-inserted']//div[";
    public String fnfColumnHeader="//div[@data-csautomation-key='FRIENDS_AND_FAMILY']//div[@class='table-data-wrapper ng-star-inserted']/div[@class='ng-star-inserted'  or @class='slide-toggle red ng-star-inserted'][";
    ...
    public By addMemberIcon=By.xpath("//div[@data-csautomation-key='FRIENDS_AND_FAMILY']//span[contains(text(),'Add')]");
