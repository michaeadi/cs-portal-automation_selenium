...
public class MoreUsageHistoryPOM extends BasePage {
    ...
    public String gettingCallHistoryNoResultFoundMessage() {
        UtilsMethods.printInfoLog("Validating error message when there is no data from com.airtel.cs.API : " + readText(callHistoryNoResultFoundMessage));
        return readText(callHistoryNoResultFoundMessage);
    }

    public boolean isCallHistoryNoResultFoundVisible() {
        UtilsMethods.printInfoLog("Validating error is visible when there is no data from com.airtel.cs.API : " + isElementVisible(callHistoryNoResultFound));
    ...
    public String gettingSMSHistoryNoResultFoundMessage() {
        UtilsMethods.printInfoLog("Validating error message when there is no data from com.airtel.cs.API : " + readText(smsHistoryNoResultFoundMessage));
        return readText(smsHistoryNoResultFoundMessage);
    }

    public boolean isSMSHistoryNoResultFoundVisible() {
        UtilsMethods.printInfoLog("Validating error is visible when there is no data from com.airtel.cs.API : " + isElementVisible(smsHistoryNoResultFound));
        return isElementVisible(smsHistoryNoResultFound);
    }

    public String gettingDataHistoryNoResultFoundMessage() {
        UtilsMethods.printInfoLog("Validating error message when there is no data from com.airtel.cs.API : " + readText(dataHistoryNoResultFoundMessage));
        return readText(dataHistoryNoResultFoundMessage);
    }

    public boolean isDataHistoryNoResultFoundVisible() {
        UtilsMethods.printInfoLog("Validating error is visible when there is no data from com.airtel.cs.API : " + isElementVisible(dataHistoryNoResultFound));
    ...
    public String getSmsBundleName(int RowNumber) {
        ...
        UtilsMethods.printInfoLog("Getting SMS Bundle Name from Row Number " + RowNumber + " : " + rowElement.findElement(bundleName).getText());
    ...
    public String getCallBundleName(int RowNumber) {
        ...
        UtilsMethods.printInfoLog("Getting Call Bundle Name from Row Number " + RowNumber + " : " + rowElement.findElement(bundleName).getText());
        return rowElement.findElement(bundleName).getText();
    }

    public String getDataBundleName(int RowNumber) {
        WebElement rowElement = dataHistoryRowsElements.get(RowNumber);
        UtilsMethods.printInfoLog("Getting Data Bundle Name from Row Number " + RowNumber + " : " + rowElement.findElement(bundleName).getText());
        return rowElement.findElement(bundleName).getText();
    }

    public String getDataTransactionNumber(int RowNumber) {
        WebElement rowElement = dataHistoryRowsElements.get(RowNumber);
        UtilsMethods.printInfoLog("Getting Data Transaction Number from Row Number " + RowNumber + " : " + rowElement.findElement(transactionNumber).getText());
        return rowElement.findElement(transactionNumber).getText();
    }

    public String getCallTransactionNumber(int RowNumber) {
        WebElement rowElement = callHistoryRowsElements.get(RowNumber);
        UtilsMethods.printInfoLog("Getting Call Transaction Number from Row Number " + RowNumber + " : " + rowElement.findElement(transactionNumber).getText());
        return rowElement.findElement(transactionNumber).getText();
    }

    public String getSMSTransactionNumber(int RowNumber) {
        WebElement rowElement = smsHistoryRowsElements.get(RowNumber);
        UtilsMethods.printInfoLog("Getting SMS Transaction Number from Row Number " + RowNumber + " : " + rowElement.findElement(transactionNumber).getText());
        return rowElement.findElement(transactionNumber).getText();
    }

    public String getSMSDateTime(int RowNumber) {
        WebElement rowElement = smsHistoryRowsElements.get(RowNumber);
        UtilsMethods.printInfoLog("Getting SMS Date and Time from Row Number " + RowNumber + " : " + rowElement.findElement(dateTime).getText());
    ...
    public String getDataDateTime(int RowNumber) {
        WebElement rowElement = dataHistoryRowsElements.get(RowNumber);
        UtilsMethods.printInfoLog("Getting Data Date and Time from Row Number " + RowNumber + " : " + rowElement.findElement(dateTime).getText());
        return rowElement.findElement(dateTime).getText();
    }

    public String getSMSTo(int RowNumber) {
        WebElement rowElement = smsHistoryRowsElements.get(RowNumber);
        UtilsMethods.printInfoLog("Getting SMS To from Row Number " + RowNumber + " : " + rowElement.findElement(smsTo).getText());
        return rowElement.findElement(smsTo).getText();
    }

    public String getSMSCharges(int RowNumber) {
        WebElement rowElement = smsHistoryRowsElements.get(RowNumber);
        UtilsMethods.printInfoLog("Getting SMS Charges from Row Number " + RowNumber + " : " + rowElement.findElement(smsCharges).getText());
        return rowElement.findElement(smsCharges).getText();
    }

    public String getCallCharges(int RowNumber) {
        WebElement rowElement = callHistoryRowsElements.get(RowNumber);
        UtilsMethods.printInfoLog("Getting Call Charges from Row Number " + RowNumber + " : " + rowElement.findElement(callCharges).getText());
        return rowElement.findElement(callCharges).getText();
    }

    public String getDataCharges(int RowNumber) {
        WebElement rowElement = dataHistoryRowsElements.get(RowNumber);
        UtilsMethods.printInfoLog("Getting Data Charges from Row Number " + RowNumber + " : " + rowElement.findElement(dataCharges).getText());
        return rowElement.findElement(dataCharges).getText();
    }

    public String getCallTo(int RowNumber) {
        WebElement rowElement = callHistoryRowsElements.get(RowNumber);
        UtilsMethods.printInfoLog("Getting Call To from Row Number " + RowNumber + " : " + rowElement.findElement(callTo).getText());
        return rowElement.findElement(callTo).getText();
    }

    public String getUsedData(int RowNumber) {
        WebElement rowElement = dataHistoryRowsElements.get(RowNumber);
        UtilsMethods.printInfoLog("Getting Used Data To from Row Number " + RowNumber + " : " + rowElement.findElement(usedData).getText());
        return rowElement.findElement(usedData).getText();
    }

    public String getCallDuration(int RowNumber) {
        WebElement rowElement = callHistoryRowsElements.get(RowNumber);
        UtilsMethods.printInfoLog("Getting Used Data To from Row Number " + RowNumber + " : " + rowElement.findElement(callDuration).getText());
