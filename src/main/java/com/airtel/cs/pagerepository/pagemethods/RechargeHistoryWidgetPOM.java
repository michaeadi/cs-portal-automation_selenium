...
public class RechargeHistoryWidgetPOM extends BasePage {
    ...
    public boolean isRechargeHistoryErrorVisible() {
        UtilsMethods.printInfoLog("Validating error is visible when there is Error in com.airtel.cs.API : " + isElementVisible(rechargeHistoryError));
    ...
    public String gettingRechargeHistoryNoResultFoundMessage() {
        UtilsMethods.printInfoLog("Validating error message when there is no data from com.airtel.cs.API : " + readText(rechargeHistoryNoResultFoundMessage));
        return readText(rechargeHistoryNoResultFoundMessage);
    }

    public boolean isRechargeHistoryNoResultFoundVisible() {
        UtilsMethods.printInfoLog("Validating error is visible when there is no data from com.airtel.cs.API : " + isElementVisible(rechargeHistoryNoResultFound));
