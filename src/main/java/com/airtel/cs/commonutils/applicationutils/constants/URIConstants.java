...
public class URIConstants {
    ...
    public static final String ENTERPRISE_POSTPAID_ACCOUNT_INFORMATION="/cs-gsm-service/v1/enterprise/postpaid/account/information";
    public static final String ENTERPRISE_POSTPAID_ACCOUNT_DETAILS="/cs-gsm-service/v1/enterprise/postpaid/account/details";
