...
public class SupervisorSearchTicket extends BaseTest {
    ...
    @Test(priority = 3, description = "Validate Assign to Agent and Transfer to Queue Option", dataProviderClass = DataProviders.class,dependsOnMethods = "agentSkipQueueLogin")
