...
public class MoreUsageHistoryPOM extends BasePage {
    ...
    public String gettingCallHistoryNoResultFoundMessage() {
        UtilsMethods.printInfoLog("Validating error message when there is no data from API : " + readText(callHistoryNoResultFoundMessage));
        return readText(callHistoryNoResultFoundMessage);
    }

    public boolean isCallHistoryNoResultFoundVisible() {
        UtilsMethods.printInfoLog("Validating error is visible when there is no data from API : " + isElementVisible(callHistoryNoResultFound));
    ...
    public String gettingSMSHistoryNoResultFoundMessage() {
        UtilsMethods.printInfoLog("Validating error message when there is no data from API : " + readText(smsHistoryNoResultFoundMessage));
        return readText(smsHistoryNoResultFoundMessage);
    }

    public boolean isSMSHistoryNoResultFoundVisible() {
        UtilsMethods.printInfoLog("Validating error is visible when there is no data from API : " + isElementVisible(smsHistoryNoResultFound));
        return isElementVisible(smsHistoryNoResultFound);
    }

    public String gettingDataHistoryNoResultFoundMessage() {
        UtilsMethods.printInfoLog("Validating error message when there is no data from API : " + readText(dataHistoryNoResultFoundMessage));
        return readText(dataHistoryNoResultFoundMessage);
    }

    public boolean isDataHistoryNoResultFoundVisible() {
        UtilsMethods.printInfoLog("Validating error is visible when there is no data from API : " + isElementVisible(dataHistoryNoResultFound));
