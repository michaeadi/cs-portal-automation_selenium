...
public class FrontendTicketHistory extends BasePage {
    ...
    public String getTicketId(int index){
        By ticketID= By.xpath("//table[@id='fetchTicketByCustomer']//tr["+index+"]//td[1]//p[1]//b[1]");
    ...
    public String getTicketPriority(int index){
        By ticketPriority= By.xpath("//table[@id='fetchTicketByCustomer']//tr["+index+"]//td[1]//p[1]//b[2]");
    ...
    public String getTicketQueue(int index){
        By ticketQueue= By.xpath("//table[@id='fetchTicketByCustomer']//tr["+index+"]//td[3]//p[1]");
    ...
    public String getTicketState(int index){
        By ticketState=By.xpath("//table[@id='fetchTicketByCustomer']//tr["+index+"]//td[4]//p[1]");
    ...
    public String getCloseDate(int index){
        By ticketCloseDate=By.xpath("//table[@id='fetchTicketByCustomer']//tr["+index+"]//td[5]//p[1]//span[1]");
    ...
    public String getCloseTime(int index){
        By ticketCloseTime=By.xpath("//table[@id='fetchTicketByCustomer']//tr["+index+"]//td[5]//p[1]");
    ...
    public String getCreatedBy(int index){
        By ticketCreatedBy=By.xpath("//table[@id='fetchTicketByCustomer']//tr["+index+"]//td[6]//p[1]");
    ...
    public String getCreationDate(int index){
        By ticketCreationDate=By.xpath("//table[@id='fetchTicketByCustomer']//tr["+index+"]//td[7]//p[1]//span[1]");
    ...
    public String getCreationTime(int index){
        By ticketCreationTime=By.xpath("//table[@id='fetchTicketByCustomer']//tr["+index+"]//td[7]//p[1]");
    ...
    public void clickAddToInteraction(int index){
        By addToInteractionBtn=By.xpath("//table[@id='fetchTicketByCustomer']//tr["+index+"]//td[7]//span[1]//a[1]//img");
    ...
    public void clickReopen(int index){
        By reopenBtn=By.xpath("//table[@id='fetchTicketByCustomer']//tr["+index+"]//td[7]//span[1]//a[2]//img");
