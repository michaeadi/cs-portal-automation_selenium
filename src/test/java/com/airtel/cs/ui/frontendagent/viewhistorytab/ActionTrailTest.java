...
public class ActionTrailTest extends Driver {
    ...
    public void isUserHasActionTrailPermission() {
        try {
            ...
            assertCheck.append(actions.assertEqualBoolean(true, UtilsMethods.isUserHasPermission(actionTrail), "Action trail permission displayed correctly as per user permission", "Action trail permission does not display correctly as per user permission"));
        } catch (Exception e) {
