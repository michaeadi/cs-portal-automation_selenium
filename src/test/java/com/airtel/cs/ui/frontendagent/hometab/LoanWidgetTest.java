                        ...
                        if (summary.getStatusCode().equalsIgnoreCase("200")) {
                            try {
                                ...
                                try {
                                    ...
                                    Loan loanDetails = api.loanDetailsTest(customerNumber, vendorName);
                                    try {
                                        assertCheck.append(actions.assertNotEqual_stringType(loanDetail.getLoanHistoryHeaderName(1).toLowerCase().trim(), data.getRow1().toLowerCase().trim(), "Loan History Widget Header Name at POS(1) is same as mentioned in excel", "Loan History Widget Header Name at POS(1) not same as mentioned in excel"));
                                        assertCheck.append(actions.assertNotEqual_stringType(loanDetail.getLoanHistoryHeaderName(2).toLowerCase().trim(), data.getRow2().toLowerCase().trim(), "Loan History Widget Header Name at POS(2) is same as mentioned in excel", "Loan History Widget Header Name at POS(2) not same as mentioned in excel"));
                                        assertCheck.append(actions.assertNotEqual_stringType(loanDetail.getLoanHistoryHeaderName(3).toLowerCase().trim(), data.getRow3().toLowerCase().trim(), "Loan History Widget Header Name at POS(3) is same as mentioned in excel", "Loan History Widget Header Name at POS(3) not same as mentioned in excel"));
                                        assertCheck.append(actions.assertNotEqual_stringType(loanDetail.getLoanHistoryHeaderName(4).toLowerCase().trim(), data.getRow4().toLowerCase().trim(), "Loan History Widget Header Name at POS(4) is same as mentioned in excel", "Loan History Widget Header Name at POS(4) not same as mentioned in excel"));
                                        assertCheck.append(actions.assertNotEqual_stringType(loanDetail.getLoanHistoryHeaderName(5).toLowerCase().trim(), data.getRow5().toLowerCase().trim(), "Loan History Widget Header Name at POS(5) is same as mentioned in excel", "Loan History Widget Header Name at POS(5) not same as mentioned in excel"));
