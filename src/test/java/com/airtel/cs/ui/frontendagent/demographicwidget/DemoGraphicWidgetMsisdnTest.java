...
public class DemoGraphicWidgetMsisdnTest extends Driver {
    ...
    public void testAirtelMoneyProfile() {
        try {
            if (StringUtils.equalsIgnoreCase(constants.getValue(ApplicationConstants.AIRTEL_MONEY_PROFILE), "true")) {
                ...
                assertCheck.append(actions.assertEqualIntType(statusCode, 200, "Profile API Status Code Matched and is :" + statusCode, "Profile API Status Code NOT Matched and is :" + statusCode));
                final int amProfileAPIStatusCode = amProfileAPI.getStatusCode();
                assertCheck.append(actions.assertEqualIntType(amProfileAPIStatusCode, 200, "AM Profile API Status Code Matched and is :" + amProfileAPIStatusCode, "AM Profile API Status Code NOT Matched and is :" + amProfileAPIStatusCode));
    ...
    public void testCustomerInfo() {
        try {
            ...
            assertCheck.append(actions.assertEqualIntType(statusCode, 200, "GSM KYC API Status Code Matched and is :" + statusCode, "GSM KYC API Status Code NOT Matched and is :" + statusCode));
            ...
            if (!customerName.contains("Unable to fetch data")) {
                ...
                assertCheck.append(actions
                        .assertEqualStringType(customerDOB.trim(), UtilsMethods.getDateFromEpoch(gsmKycAPI.getResult().getDob(), "dd-MMM-yyyy"),
    ...
    public void testSIMNumberAndGSMStatus() {
        try {
            ...
            assertCheck.append(actions.assertEqualStringType(simNumber.trim(), kycProfile.getResult().getSim(),
            ...
            if (!simNumber.contains("Unable to fetch data")) {
                ...
                assertCheck.append(actions
                        .assertEqualStringType(pages.getDemoGraphicPage().getPIN1(), kycProfile.getResult().getPin1() == null || kycProfile.getResult().getPin1().equals("") ? "-" : kycProfile.getResult().getPin1(), "PIN1 Matched Successfully",
                                "PIN1 NOT Matched"));
                assertCheck.append(actions
                        .assertEqualStringType(pages.getDemoGraphicPage().getPIN2(), kycProfile.getResult().getPin2() == null || kycProfile.getResult().getPin2().equals("") ? "-" : kycProfile.getResult().getPin2(), "PIN2 Matched Successfully",
                                "PIN2 NOT Matched"));
            }
    ...
    public void testDataManagerAndDeviceCompatible() {
        try {
            ...
            assertCheck.append(actions.assertEqualIntType(profileAPIStatusCode, 200, "Profile API Status Code Matched and is :" + profileAPIStatusCode, "Profile API Status Code NOT Matched and is :" + profileAPIStatusCode));
            if (StringUtils.equalsIgnoreCase(constants.getValue(ApplicationConstants.DATA_MANAGER_TOGGLEABLE), "True"))
                if (pages.getDemoGraphicPage().getDataManagerStatus().equalsIgnoreCase("true"))
                    assertCheck.append(actions.assertEqualStringType("on", plansAPI.getResult().getDataManager().toLowerCase().trim(),
                            "Customer's Data Manager Status is as Expected", "Customer's Data Manager Status is not as Expected"));
                else
                    assertCheck.append(actions.assertEqualStringType("off", plansAPI.getResult().getDataManager().toLowerCase().trim(),
                            "Customer's Data Manager Status is as Expected", "Customer's Data Manager Status is not as Expected"));
            else
            ...
            assertCheck.append(actions.assertEqualStringType(pages.getDemoGraphicPage().getDeviceCompatible(), deviceType,
            ...
            assertCheck.append(actions.assertEqualStringType(pages.getDemoGraphicPage().getSimType().trim(), simType,
    ...
    public void testConnectionTypeServiceCategorySegment() {
        try {
            ...
            if (!segment.contains("Unable to fetch data")) {
                ...
                assertCheck.append(actions.assertEqualStringType(pages.getDemoGraphicPage().getSubSegment(), kycProfile.getResult().getSubSegment() == null || kycProfile.getResult().getSubSegment().equals("") ? "-" : kycProfile.getResult().getSubSegment(), "Customer Sub Segment as expected",
    ...
    public void testDeviceInfo() {
        try {
            ...
            assertCheck.append(actions
                    .assertEqualStringType(pages.getDemoGraphicPage().getIMEINumber().trim(), profileAPI.getResult().getImeiNumber(),
