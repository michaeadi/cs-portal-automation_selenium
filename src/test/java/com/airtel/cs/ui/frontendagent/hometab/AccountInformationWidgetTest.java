...
public class AccountInformationWidgetTest extends Driver {
    ...
    public void verifyAccountInfoDetailedIcon() {
        ...
        try {
            ...
            assertCheck.append(actions.assertEqualStringType(pages.getAccountInformationWidget().getValue(postpaidAccountInformation, "lastPaymentAmount", "statusCode"), "200", "Postpaid Account Information API 5 Status Code Matched", "Postpaid Account Information API 5 Status Code NOT Matched", false));
            assertCheck.append(actions.assertEqualStringType(pages.getAccountInformationWidget().getValue(postpaidAccountInformation, "securityDeposit", "statusCode"), "200", "Postpaid Account Information API 6 Status Code Matched", "Postpaid Account Information API 6 Status Code NOT Matched", false));
