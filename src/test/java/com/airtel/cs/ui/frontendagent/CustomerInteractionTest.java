...
public class CustomerInteractionTest extends Driver {
    ...
    public void validateDemographicInformation(TestDatabean data) {
        try {
            ...
            commonLib.fail("Exception in Method - validateDemographicInformation" + e.fillInStackTrace(), true);
        }
    }
    ...
    public void openCustomerInteractionAPI(TestDatabean data) {
        try {
            ...
            commonLib.fail("Exception in Method - openCustomerInteractionAPI" + e.fillInStackTrace(), true);
        }
    }
