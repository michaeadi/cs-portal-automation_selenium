...
public class HbbWidgetsVisibilityTest extends Driver {
    ...
    public void widgetsVisibility() {
        try {
            ...
            assertCheck.append(actions.assertEqualBoolean(pages.getHbbProfilePage().issCurrentPlanVisible(), true, "Current Plan is successfully displayed ", "Current Plan is not displayed"));
            ...
            assertCheck.append(actions.assertEqualBoolean(pages.getCustomerProfilePage().isSendInternetSettingTitleVisible(), false, "Send Internet Settings not visible  ", "Send Internet Settings is visible"));
