...
public class TariffPlanMigrationTest extends PreRequisites {
    ...
    public void testChangeServiceClassVisibleAndClickable() {
        ExtentTestManager.startTest("Validating Change Service Class option is visible or not under Actions tab", "Validate Service Class Option is visible or not under Actions tab");
    ...
    public void testValidateCustomerCurrentPlanDetails() {
        ExtentTestManager.startTest("Validate Customer Current Plan Details under Service Class Tab", "Validate Customer Current Plan Details under Service Class tab");
