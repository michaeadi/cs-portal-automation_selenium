...
public class RechargeHistoryMenuWidgetTest extends Driver {
    ...
    @DataProviders.Table(name = "More Recharge History")
    @Test(priority = 3, groups = {"SanityTest", "RegressionTest"}, dataProvider = "HeaderData", dataProviderClass = DataProviders.class, dependsOnMethods = {"openCustomerInteraction", "rechargeHistoryHeaderTest"})
