...
public class PsbDemoGraphicWidgetTest extends Driver {
    ...
    public void testCustomerIdAndCategory() {
        try {
            ...
            assertCheck.append(actions.assertEqualBoolean(pages.getPsbDemographicWidget().isCustomerIdInfoIconVisible(),true, "Customer Id Icon is visible", "Customer Id is NOT visible"));
            assertCheck.append(actions.matchUiAndAPIResponse(pages.getPsbDemographicWidget().getFirstName(), pages.getDemoGraphicPage().getKeyValueAPI(clmDetails.getResult().getFirstName()),"Customer FirstName is as Expected", "Customer FirstName is not same as Expected"));
            assertCheck.append(actions.matchUiAndAPIResponse(pages.getPsbDemographicWidget().getLastName(), pages.getDemoGraphicPage().getKeyValueAPI(clmDetails.getResult().getLastName()),"Customer LastName is as Expected", "Customer LastName is not same as Expected"));
            assertCheck.append(actions.matchUiAndAPIResponse(pages.getPsbDemographicWidget().getMSISDN(), pages.getDemoGraphicPage().getKeyValueAPI(clmDetails.getResult().getMSISDN()),"Customer MSISDN is as Expected", "Customer MSISDN is not same as Expected"));
