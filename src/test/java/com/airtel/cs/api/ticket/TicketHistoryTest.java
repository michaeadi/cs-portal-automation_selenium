...
import com.airtel.cs.model.request.tickethistory.TicketHistoryResult;
  ...
  TicketRequest ticketDetails;
    ...
    public void testTicketHistoryWithIssueField(NftrDataBeans list) {
      try {
        ...
        assertCheck.append(actions.assertEqualBoolean(isIssuefieldTicketfound, Boolean.TRUE,
            "Tickets Fetched of same issue Field as given in filter", "Tickets Failed to fetched of same issue Field as given in filter"));
